...
# Wi-Fi Configuration
SSID = "Arkhe"  # Replace with your Wi-Fi SSID
PASSWORD = "euler-phi"  # Replace with your Wi-Fi password

# Server Configuration
HOST = "192.168.1.7"  # Replace with the IP address of the receiver
